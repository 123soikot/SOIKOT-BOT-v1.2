module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "SOIKOT", // ক্রেডিট যদি SOIKOT ছাড়া কিছু হয় তবে কাজ করবে না
  prefix: "true",
...
if (module.exports.config.credits !== "SOIKOT") {
  throw new Error("Unauthorized modification of credits. This script will not run.");
}
...
module.exports.run = async ({ api, event, args, Users, Threads, Currencies }) => {
  ...
  // ছবি পাঠানোর জন্য কলব্যাক ফাংশন
  var callback = () =>
    api.sendMessage(
      { 
        body: `Agar Tum Gay Nhi Ho To Ye Dekho Six Pack -.-`, 
  ...
  // র‌্যান্ডম ছবি ডাউনলোড এবং পাঠানো
